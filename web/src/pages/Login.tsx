    ...
    <div className="min-h-full grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-brand-700 via-brand-600 to-ink-900 p-12 flex-col justify-between">
        ...
        <div className="relative flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-black/40 border border-white/20 backdrop-blur overflow-hidden grid place-items-center"><img src="/logo.png" alt="Aerie" className="w-full h-full object-contain" /></div>
      ...
      <div className="flex items-center justify-center p-6 min-h-screen lg:min-h-full">
        <form onSubmit={submit} className="w-full max-w-sm animate-fade-in">
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            <div className="w-11 h-11 rounded-2xl bg-ink-950 border border-white/10 overflow-hidden grid place-items-center"><img src="/logo.png" alt="Aerie" className="w-full h-full object-contain" /></div>
